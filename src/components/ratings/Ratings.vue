              ...
              <span class="item" 
               :class="{'active':selectType == 0}"
                ...
                <img v-show="selectType != 0"
                   src="./img/icon_sub_tab_dp_normal@2x.png" alt="">
                <img v-show="selectType == 0"
                src="./img/icon_sub_tab_dp_highlighted@2x.png" alt="">
              ...
              <li class="comment-item"
                ...
                <div class="comment-main">
                  ...
                  <div class="star-wrapper">
                    <span class="tex">评分</span>
                    <Star class="star"
                      :score="comment.order_comment_score"></Star>
                  </div>
                  <div class="content">
                    {{comment.comment}}
                  </div>
...
.ratings .ratigns-wrapper .content .rating-list .comment-item .comment-main{
  flex:1;
}
...
.ratings .ratinss-wrapper .content .rating-list .comment-item .comment-main .c_content{
  font-size: 13px;
  line-height: 19px;
  float: left;
  width: 100%;
...
.ratings .ratings-wrapper .content .ratings-list .comment-item .comment-main .img-wrapper{
  margin-top: 9px;
  float: left;
}
